...
let initWebRoutes = (app) => {
  ...
  router.post("/api/patient-payment", patientController.postPatientPayment);
  ...
  router.delete("/api/delete-clinic", clinicController.postSendRemedy);
  router.get(
  ...
  // delete patient
  router.delete("/api/delete-patient", clinicController.deletePatient);
